...
\kl{programs}, \kl{specifications}, and \kl{proofs}.
...
We may even wish to use a datatype more expressive than \lstinline{list}, I will show you in Chapter~\ref{chapt:pi}. % TODO
...
and fix our proof.
In that case, we could write this patched proof instead (with the difference \codediff{highlighted}):
...
For this user study, Alex and I built a Coq \kl{plugin} called \kl{\textsc{REPLica}}
