...
The \toolnamec differencing algorithms---like the \sysname differencing algorithms---are still heuristics, as is fundamental.
For \toolnamec, these heuristics are much more carefully chosen: the domain of each search procedure for \kl{automatic configuration} is defined as a large class of type equivalences,
...
since the transformation is fully general over any configuration.
