...
This chapter presents the \intro{\toolnamec} extension to the \contour[2]{violet}{\kl{\sysnamelong}} \kl{proof repair} \kl{plugin} suite.\footnote{I annotate each claim to which code is relevant with a circled number like \circled{1}. These circled numbers are links to code, and are detailed in the artifact guide: \url{https://github.com/uwplse/pumpkin-pi/blob/v2.0.0/GUIDE.md}.}
...
As the \contour[2]{violet}{\kl{\textsc{REPLica}}} user study showed, none of these were informed by the current needs of proof engineers. %~\cite{replica}. TODO elaborate?
