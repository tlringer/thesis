...
fun (T$_1$ T$_2$ : Type) (l$_1$ : list T$_1$) (l$_2$ : list T$_2$) =>
  (@\codesimb{list\_rect}@) (fun (l$_1$ : list T$_1$) => $\ldots$)
    ...
    l$_2$.
\end{lstlisting}
\caption{An \kl{Ltac} \kl{proof script} (top) and a corresponding \kl{Gallina} \kl{proof term} (bottom) in \kl{Coq} that shows that the list zip function preserves its length.
