...
my \kl{proof repair} \kl{tool suite} can extract, generalize, and apply the information that a change carries to fix proofs broken by the same change.
Proof repair can save and in fact \kl{already has saved work for proof engineers} relative to reference manual repairs in practical use cases.
