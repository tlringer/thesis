...
add something about Git, add something about hint application, add something about regrets (compiling to trees) and limitations,
...
debruijn, constants (reducing), whatever
