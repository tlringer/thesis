...
I mentioned earlier that all of \lstinline{nat}, \lstinline{list}, and \lstinline{length} can be found inside of the Coq standard library.
...
Let us start with the datatypes \lstinline{nat} and \lstinline{list}.
Each of \lstinline{nat} and \lstinline{list} in Gallina is an \intro{inductive type}:
