...
\end{enumerate}
In the \kl{Coq} proof assistant, proof engineers implement programs in a rich functional programming language called \intro{Gallina}.
...
Software Foundations~\cite{software-foundations}, and the survey paper \kl{QED at Large}.}
