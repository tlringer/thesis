...
\item \textbf{Talia Ringer}, Alex Sanchez-Stern, Dan Grossman, and Sorin Lerner. \intro{\toolname: REPL Instrumentation for Coq Analysis}~\cite{replica}. CPP 2020.
...
Parts of the introduction and Section~\ref{sec:mot-theory} come from \kl{Proof Repair across Type Equivalences}.
...
The example from Section~\ref{sec:mot-dev} comes from \kl{Ornaments for Proof Reuse in Coq}, though most of the text is new.
...
Section~\ref{sec:irl} includes a few samples of the \contour[2]{violet}{\kl{\textsc{REPLica}}} paper, as does the abstract.

\paragraph{QED at Large}
Chapter~\ref{chapt:mot} includes a few samples of the \kl{QED at Large} survey paper.
...
\kl{Alex} worked with me as a PhD student on the \kl{\toolname} user study of proof engineers during my visit \kl{UCSD}.
...
\kl{Karl} was a postdoctoral researcher when he joined me on the \kl{QED at Large}.
