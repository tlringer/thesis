...
(Explain how to get from \lstinline{f} and \lstinline{g} to configuration, adding \lstinline{Eta} and \lstinline{Iota}.)
The proof of \lstinline{coherence} follows by reflexivity. % TODO did I ever mention this by name?
