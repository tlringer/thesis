...
\lstdefinelanguage{coq}{
    keywords={Repair, module, Module, Theorem, Proof, Record, Lemma, Definition, Abort, Qed, forall, Inductive, Type, Prop, Set, fun, fix, forall, Require, Import, Fixpoint, match, end, with, as, return, struct, Qed, Defined, let, Parameter, Axiom, Patch, Configure, Preprocess},
