...
Example-based proof repair takes advantage of the fact that an example patch to a broken proof can carry enough 
...
In other words, looking back to the thesis statement, the information shows up in the difference between versions 
of the example patched proof.
...
The proof term transformations (Section~\ref{pumpkin-spec-trans}) then modify that candidate to produce the reusable proof patch.
