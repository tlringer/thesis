...
but failed to fix some of them---so yet again, sometimes, even experts give up in the face of change. % TODO how many?
...
For example, the proof of one lemma broke on this line: % TODO check to make sure this is the right theorem name IRL
