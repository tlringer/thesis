...
or any of the many similar changes extending inductive types in the \contour[2]{violet}{\kl{\textsc{REPLica}}} user study data.
...
% TODO!
%Extending proof repair tools with new search procedures is currently very difficult
%custom changes: some way of making extensible without forcing people to learn OCaml. custom unification heuristics to better handle
%things like nat to bin (honestly though that one may be doable by always reifying definitional equalities).
%obv. prototype could improve too.
%more search procedures, especially capturing common patterns.
...
Toward this end, I have just begun a promising project with \kl{RanDair}, \intro{Emily First}, and \intro{Yuriy Brun}
