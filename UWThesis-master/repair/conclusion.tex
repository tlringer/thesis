...
\end{quote}
Or, in other words, there \textit{is} reason to believe that \kl{verifying} a modified system should often, in practical use cases, be easier than verifying the original the first time around,
