...
In proof assistants that satisfy the de Bruijn criterian, proof objects are the certificates that the kernel can check to make sure it proves a given theorem.
...
\item apply differencing and transformations over reified proof objects, and finally
\item decompile the transformed proof objects to automation independent of the proof object representation.
\end{enumerate}
