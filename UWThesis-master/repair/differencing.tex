...
building on some of the insights from differencing in the \sysname prototype.
...
Still, the limitations imposed by this are partly historical: for the \sysname prototype, the heuristics were designed bottom-up, and were in many cases too narrow or redundant.
...
The \kl{\textsc{REPLica}} user study showed that, during proof development,
