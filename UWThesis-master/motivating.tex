...
This thesis describes techniques and tools for automatically repairing broken proofs in a \kl{proof assistant}.
It focuses in particular on proofs about formally \kl{verified} programs, though many of the techniques and tools carry over to mathematical proofs as well.
Formal verification of a program can improve actual and perceived reliability. % TODO QED at Large
...
The proof assistant that I motivate this on is \kl{Coq}, since this is the proof assistant for which \sysnamelong is implemented.
