...
\knowledge{notion, index=Concepts!Transport}
  | transport
\knowledge{notion, index=Collaborators!RanDair Porter}
  | RanDair Porter
  | RanDair
\knowledge{notion, index=Collaborators!Nathaniel Yazdani}
  | Nathaniel Yazdani
  | Nate Yazdani
  | Nate
\knowledge{notion, index=Collaborators!Karl Palmskog}
  | Karl Palmskog
  | Karl
...
Now that I have the chance, though, I'm having trouble figuring out where I should even begin.
...
but I trusted her, and she had gone to Maryland.
...
This is the kind of thing that I think people often forget about in acknowledgements sections.
...
I start in September, and I owe a lot of that to Lymor.
