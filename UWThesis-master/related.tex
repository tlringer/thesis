...
for improving the abstraction component. % TODO much more generalization work should be cited here; see stuff from UIUC interview follow-up email, maybe move into PUMPKIN PATCH chapter
