...
The other dapproach is to produce \intro{ephemeral proof objects} that are correct by construction~\cite{Barendregt2013}---an approach followed
...
Proof engineers often use abstractions to make proofs less likely to break to beign with.
...
Proof repair in this thesis combiness \kl{differencing} with \kl{proof term transformations}.
...
The \sysname prototype implements a kind of proof \kl{generalizaton}.
...
A number of program repair tools above---much like the proof repair tools decribed in this thesis---build on \kl{differencing} algorithms.
