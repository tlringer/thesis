...
For historical reasons, as \sysname was a prototype, these transformations are not formalized. % TODO formalize if time
...
\subsubsection*{Inversion} Sometimes, when two types are \kl{propositionally} equal,
