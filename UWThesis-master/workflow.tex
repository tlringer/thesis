...
\end{lstlisting}
\caption{The list \lstinline{zip} function, taken from an existing proof development~\cite{hstocoqv}. The curly brace notation means that the type parameter \lstinline{T} is implicit in applications.} % TODO hs-to-coq cite
\label{fig:zip}
\end{figure}
