...
After compiling to trees,
\sysname automatically infers which configuration to use for the procedure from the example change. For example, to
find a patch for the case study we will see in Section~\ref{sec:compcert}, I
